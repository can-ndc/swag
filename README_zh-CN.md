...
[![Travis Status](https://img.shields.io/travis/can-ndc/swag/master.svg)](https://travis-ci.org/can-ndc/swag)
...
从源码开始构建的话，需要有 Go 环境（1.16 及以上版本）。
...
[点击此处](https://github.com/can-ndc/swag/tree/master/example/celler)查看示例源代码。
...
此处查看格式化结果 [here](https://github.com/can-ndc/swag/tree/master/example/celler).
...
**示例** [`celler/main.go`](https://github.com/can-ndc/swag/blob/master/example/celler/main.go)
...
Example [celler/controller](https://github.com/can-ndc/swag/tree/master/example/celler/controller)
...
[#379](https://github.com/can-ndc/swag/issues/379)
